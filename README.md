...
- 首次身份选择、可跳过绑定、对话采集基本档案、自动记录与修改
- 老人端“助手 / 报告 / 我的”，家属端“概况 / 健康报告 / 家庭环境 / 我的”
- 老人端聊天 Agent（主诉识别 + 可配置 DeepSeek 回复，支持连续语音输入）
- 个人记录与演示样例隔离；基本档案进入 Person Twin，拍照仅保留明确标注的预览演示
- 变化检测引擎（单指标偏离 + 多信号融合，内置"活动耐量下降"演示场景）
- 每周健康周报（自动生成给老人和给子女两个版本）
- 分级家属通知本地展示；报告和待办统一按绑定、授权及可见性过滤，不执行真实推送
- 家庭环境为待接入页面，尚未提供三维建模或上传
