import type { ChatMessage, FamilyHealthEvent, HealthMeasurement, LabResult, Observation } from '../types';
 ...
 * A real product should replace this with an authenticated remote store with explicit retention policy.
 */
