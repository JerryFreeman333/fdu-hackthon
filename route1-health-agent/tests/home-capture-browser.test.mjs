...
await page.addInitScript(() => {
  navigator.mediaDevices.getUserMedia = async () => {
    ...
    context.fillStyle = '#72baff'; context.fillRect(0, 0, 320, 240);
...
try {
  ...
  console.log('PASS recording/pause/review/upload/track cleanup/reload persistence/mobile layout. GPU training not simulated as completion.');
